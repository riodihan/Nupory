...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jan 2020 pada 11.29
...
('B001', 'K001', 'krisan spray', 10000, 59, 'bunga 1.jpeg', '-', '-', 'Bunga Krisan adalah sejenis tumbuhan berbunga yang sering ditanam sebagai tanaman hias pekarangan atau bunga petik. Tumbuhan berbunga ini mulai muncul pada zaman Kapur.'),
...
CREATE TRIGGER `kurang_stok_bunga` AFTER UPDATE ON `detail_transaksi` FOR EACH ROW BEGIN
    ...
    WHERE detail_transaksi.ID_STATUS_TRANSAKSI = '03' AND
...
('T002', '03', '01', 'idris', '2020-01-15', '', 100000, '');
