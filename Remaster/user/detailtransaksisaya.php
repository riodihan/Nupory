...
if ($_POST['rowid']) {
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM transaksi
                        ...
                        WHERE transaksi.ID_STATUS_TRANSAKSI = 05 && transaksi.ID_TRANSAKSI = '$id'
                            
                            ");
    $total = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE ID_STATUS_TRANSAKSI = 05 && transaksi.ID_TRANSAKSI = '$id'");
