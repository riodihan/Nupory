...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="page-title">Lokasi Kami</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="page-content" class="container-fluid">
        <div class="container">
            ...
            <div id="googleMap" style="width:100%;"></div><br>
            <div class="col-sm-6 col-md-7" style="float: right;">
                <a class="btn btn-info" href="https://www.google.com/maps/place/Kebun+Pengembangan+holtikultura/@-8.079594,113.690625,16z/data=!4m5!3m4!1s0x0:0x6c0a7d5c0bad1a23!8m2!3d-8.0795942!4d113.6906249?hl=id">Buka Di Google Maps</a>
            </div>
        </div>
    </div>
