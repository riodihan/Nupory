...
$keranjang = query4("SELECT * FROM pemesanan
                    inner join detail_transaksi on pemesanan.id_pemesanan = detail_transaksi.id_transaksi
                    inner join bunga on pemesanan.id_bunga = bunga.id_bunga
                    inner join pembayaran on pemesanan.id_pembayaran = pembayaran.id_pembayaran
